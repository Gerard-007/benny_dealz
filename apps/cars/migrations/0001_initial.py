    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body_type', models.CharField(choices=[('Bus', 'Bus'), ('Coupe', 'Coupe'), ('Hatchback', 'Hatchback'), ('Pickup', 'Pickup'), ('Suv', 'Suv'), ('Convertible', 'Convertible'), ('Crossover', 'Crossover'), ('Mpv', 'Mpv'), ('Sedan', 'Sedan'), ('Truck', 'Truck')], max_length=100)),
                ...
                ('fuel', models.CharField(choices=[('Diesel', 'Diesel'), ('PetroleumGas', 'PetroleumGas'), ('Petrol', 'Petrol'), ('Hybrid', 'Hybrid')], max_length=100)),
