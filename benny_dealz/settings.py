"""
Django settings for benny_dealz project.
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        'FETCH_USERINFO': True,
        'APP': {
            'client_id': '228043902540-hp6dcu4rs7qlpekevcmm56eaapsp4mpa.apps.googleusercontent.com',
            'secret': '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',
        },
        'SCOPE': [
            'profile',
            'email',
